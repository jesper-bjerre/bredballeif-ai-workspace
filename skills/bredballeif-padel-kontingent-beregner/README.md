...
```powershell
.\bin\bredballeif-padel-kontingent-beregner.ps1 beregn --date 2026-05-15
```

Linux/OpenClaw wrapper:

```bash
./bin/bredballeif-padel-kontingent-beregner.sh beregn --date 2026-05-15
```
...
```powershell
cd skills\bredballeif-padel-kontingent-beregner
$env:PYTHONPATH = ".\scripts"
