...
def build_parser() -> argparse.ArgumentParser:
    ...
    listing.add_argument("--limit", type=int, default=10, choices=range(1, 11), metavar="1..10")
    ...
    history_list.add_argument("--limit", type=int, default=10, choices=range(1, 11), metavar="1..10")
    ...
    matching.add_argument("--limit", type=int, default=10, choices=range(1, 11), metavar="1..10")
    ...
    batch.add_argument("--limit", type=int, default=10, choices=range(1, 11), metavar="1..10")
